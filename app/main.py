...
BOT_COMMANDS = [
    ...
    BotCommand(command="backup", description="Бэкап конфигов в чат"),
    ...
    BotCommand(command="vpn_users", description="VPN: кто подключён и сколько качает"),
    BotCommand(command="vpn_add", description="VPN: выдать доступ человеку"),
    BotCommand(command="vpn_link", description="VPN: ссылка и QR для человека"),
    BotCommand(command="vpn_del", description="VPN: отозвать доступ"),
    BotCommand(command="vpn_server", description="VPN: сменить адрес сервера"),
