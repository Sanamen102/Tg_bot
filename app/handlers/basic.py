...
/heavy — тяжёлые фильмы: лишние дорожки и сколько места освободится
/originals — оригиналы, отложенные после облегчения
После закачки тяжёлого фильма сам предложу его облегчить
