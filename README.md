...
| `YTDL_PROXY` | — | Прокси для заблокированных сайтов (напр. `socks5://xray:1080`). TikTok/Instagram идут через него сразу, остальное — напрямую с автоповтором через прокси при сбое |
